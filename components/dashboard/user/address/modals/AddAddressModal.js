          ...
          {selectedAreaDetails && (
            <Box sx={addressStyles.deliveryInfo}>
              <Typography sx={addressStyles.deliveryText}>
                <strong>Delivery Fee:</strong> ${selectedAreaDetails.delivery_fee}
              </Typography>
              <Typography sx={addressStyles.deliveryText}>
                <strong>Delivery Time:</strong> {selectedAreaDetails.min_delivery_time} - {selectedAreaDetails.max_delivery_time}
              </Typography>
            </Box>
          )}
