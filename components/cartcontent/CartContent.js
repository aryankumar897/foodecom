...
//       try {
//         setIsLoading(true);
//         const response = await fetch(`${process.env.API}/user/add-to-cart`); // Replace with your actual API endpoint
//         if (!response.ok) {
...
//     try {
//       setIsAnimating(true);
//       const response = await fetch(`${process.env.API}/user/cart/${id}`, {
//         method: "DELETE",
//       });
